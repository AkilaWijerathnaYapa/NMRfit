---
title: "NMRfit" # Title of the document
author: "Who are the list of authors and order" # Replace with actual author names
---
...
![Fig.4. Output files](Figures/Fig.4._Output_files.JPG)
